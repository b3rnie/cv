...
Software engineer specializing in backend, big-data, cloud and robust systems.

I have worked at small startups and large companies. Building software from scratch, deve\-loped or migrated mature complex systems. I enjoy complex problems and finding easy solutions.
...
\item[] \textit{Engineer}
  ...
  \begin{innerlist}
  \item
        Rewrote the news-publishing pipeline for Dagens Industri. Removed a large legacy CRM called EPi-server. Migrated on-prem databases software to k8s and Google Cloud.
  \item
        Developed many data-pipelines using on Apache/Airflow, Dataflow and BigQuery.
  \end{innerlist}
\end{outerlist}
\halfblankline
...
\item[] \textit{Consulting}
  ...
  \begin{innerlist}
    \item
      Designed, implemented and maintained a batch processing system.
      The system was built to scale and be
